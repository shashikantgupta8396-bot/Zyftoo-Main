...
export default function ProductDetails() {
    ...
    useEffect(() => {
        // Redirect corporate users to corporate-shop product details
        if (user && (user.accountType === 'corporate' || user.userType === 'Corporate')) {
            console.log(`🔄 [Shop Details] Redirecting corporate user to corporate-shop/${params.id}`)
            router.replace(`/corporate-shop/${params.id}`)
            return
        }
    ...
    // Don't render regular product details if user is corporate (while redirecting)
    if (user && (user.accountType === 'corporate' || user.userType === 'Corporate')) {
        return (
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Product Details">
                <div className="container py-5">
                    <div className="text-center">
                        ...
                        <p className="mt-3">Redirecting to Corporate Product Details...</p>
                    </div>
                </div>
            </Layout>
        )
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={product.name}>
                <div>
                                ...
                                <div className="col-lg-5 col-md-7">
                                    <div className="tpproduct-details__content">
                                        ...
                                        <div className="tpproduct-details__price mb-30">
                                            ...
                                            <span>₹{product.price?.max ? product.price.max * 100 : 31.00}</span>
                                        </div>
