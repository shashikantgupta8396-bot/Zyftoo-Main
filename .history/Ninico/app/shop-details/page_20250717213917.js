...
export default function ShopDetails() {
    ...
    useEffect(() => {
        ...
        if (productId) {
            // Here you would typically fetch product data from an API
            // For now, we'll use sample data with different values based on ID
                                                    ...
                                                    <table className="table table-striped">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td className="add-info-list"> Standard shipping: ?59.50</td>
                                                            </tr>
                                                            <tr>
