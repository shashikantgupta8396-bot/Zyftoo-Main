...
export default function AdminLoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.log('🔒 Login data encrypted')

      // Send login request with encrypted data
      const res = await post(AUTH.LOGIN, { encryptedData }, false) // false to prevent default handling
