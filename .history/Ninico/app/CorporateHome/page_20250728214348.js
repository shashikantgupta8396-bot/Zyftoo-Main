...
import CorporateAwareFilterShopBox from "@/components/shop/CorporateAwareFilterShopBox"
                                ...
                                <div className="corporate-welcome-banner">
                                    <div className="welcome-content">
                                        ...
                                        <div className="corporate-actions">
                                            ...
                                            <Link href="/corporate-shop" className="btn btn-corporate-secondary">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                <div className="tpproductall text-end">
                                    <Link href="/corporate-shop" className="btn btn-primary">
