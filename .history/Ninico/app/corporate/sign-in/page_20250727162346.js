...
export default function CorporateSignIn() {
    ...
    const handleForgotPassword = async () => {
        ...
        try {
            ...
            // Since we have email check working, we need to get the phone from the user ID
            // For now, let's require phone number input for password reset
            setToast('Please contact support for password reset')
            return
            
            // TODO: Implement phone number retrieval from user ID
