                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-12">
                                <div className="tpproduct-details__content tpproduct-details__sticky">
                                    ...
                                    <div className="corporate-banner mb-3 p-2 bg-primary text-white rounded d-flex align-items-center">
                                        <i className="fas fa-building me-2"></i>
                                        <span className="fw-bold">Corporate Business Product</span>
                                        <span className="ms-auto badge bg-warning text-dark">B2B Pricing</span>
                                    </div>
                                    ...
                                    <div className="corporate-features-section mb-4 p-3 border rounded bg-light">
                                        ...
                                        <div className="row">
                                            <div className="col-md-6 mb-2">
                                                <div className="feature-item d-flex align-items-center">
                                                    ...
                                                    <span className="small">
                                                        <strong>Bulk Orders:</strong> Min {product.minOrder} pieces
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="col-md-6 mb-2">
                                                <div className="feature-item d-flex align-items-center">
                                                    ...
                                                    <span className="small">
                                                        <strong>Customization:</strong> Logo printing available
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="col-md-6 mb-2">
                                                <div className="feature-item d-flex align-items-center">
                                                    ...
                                                    <span className="small">
                                                        <strong>GST Invoice:</strong> Business compliant billing
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="col-md-6 mb-2">
                                            ...
                                            <div className="col-md-6 mb-2">
                                                <div className="feature-item d-flex align-items-center">
                                                    ...
                                                    <span className="small">
                                                        <strong>Trade Assurance:</strong> Secure B2B transaction
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="col-md-6 mb-2">
                                                <div className="feature-item d-flex align-items-center">
                                                    ...
                                                    <span className="small">
                                                        <strong>Gift Packaging:</strong> Professional presentation
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-3">
                                            <h6 className="fw-bold mb-2 text-success">Volume Pricing Benefits</h6>
                                            <div className="table-responsive">
                                                <table className="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        {product.corporatePricing.priceTiers.map((tier, index) => (
                                                            <tr key={index} className={selectedQuantity >= tier.minQuantity && 
                                                                (tier.maxQuantity === null || selectedQuantity <= tier.maxQuantity) ? 'table-success' : ''}>
                                                                <td className="text-center">
                                                                    {tier.minQuantity}+ {tier.maxQuantity ? `- ${tier.maxQuantity}` : ''}
                                                                </td>
                                                                <td className="text-center fw-bold">₹{tier.pricePerUnit}</td>
                                                                <td className="text-center text-success">{tier.discount}% OFF</td>
                                                                <td className="text-center">
                                                                    ₹{((product.retailPrice.mrp - tier.pricePerUnit) * tier.minQuantity).toLocaleString()}
                                                                </td>
                                                            </tr>
                                                        ))}
                                                    </tbody>
                                    ...
                                    <div className="supplier-info-section mt-4 p-3 border rounded bg-white">
                                        <h6 className="fw-bold mb-3 text-primary">
                                            ...
                                            <div className="col-md-6">
                                                <div className="supplier-details">
                                                    <div className="d-flex align-items-center mb-2">
                                                        ...
                                                        <strong>NIC Industries Pvt Ltd</strong>
                                                    </div>
                                                    <div className="d-flex align-items-center mb-2">
                                                    ...
                                                    <div className="d-flex align-items-center mb-2">
                                                        ...
                                                        <span className="small">Verified Supplier</span>
                                                        <span className="badge bg-success ms-2">5 Years</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="supplier-stats">
                                                    <div className="d-flex justify-content-between mb-1">
                                                        <span className="small">Response Rate:</span>
                                                        <span className="fw-bold text-success">98%</span>
                                                    </div>
                                                    <div className="d-flex justify-content-between mb-1">
                                                        <span className="small">On-time Delivery:</span>
                                                        <span className="fw-bold text-success">95%</span>
                                                    </div>
                                                    <div className="d-flex justify-content-between mb-1">
                                                        <span className="small">Quality Rating:</span>
                                    ...
                                    <div className="tpproduct pb-15 mb-30">
                                        ...
                                        <div className="tpproduct__content">
                                            ...
                                            <div className="tpproduct__priceinfo p-relative">
                                                ...
                                                <div className="tpproduct__cart">
                                                    <Link href="/corporate-shop/3"><i className="fal fa-eye" />View Details</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
