                                ...
                                <div className="list-group list-group-flush" style={{ maxHeight: '400px', overflowY: 'auto' }}>
                                  {mainCategories.map((category, index) => {
                                    ...
                                    return (
                                      <div 
                                        key={category.id} 
                                        className={`list-group-item list-group-item-action border-0 ${isActiveTab ? 'active' : ''} ${isSelected ? 'bg-light border-start border-primary border-3' : ''}`}
                                        ...
                                        <div className="d-flex align-items-center">
                                          ...
                                          <div className="flex-grow-1">
                                            <div className="d-flex justify-content-between align-items-center">
                                              <div>
                                                <h6 className={`mb-1 ${isActiveTab ? 'text-white' : 'text-dark'}`}>
                                                  {category.name}
                                                </h6>
                                              ...
                                              <div className="text-end">
                                                {subcategoryCount > 0 && (
                                                  <span className={`badge ${isActiveTab ? 'bg-white text-primary' : 'bg-primary'}`}>
                                                    {subcategoryCount} subs
                                                  </span>
                                                )}
                                                <i className={`bi bi-chevron-right ms-2 ${isActiveTab ? 'text-white' : 'text-muted'}`}></i>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                ...
                                {selectedMainCategory ? (
                                  selectedCategorySubcategories.length > 0 ? (
                                    <div className="list-group list-group-flush" style={{ maxHeight: '400px', overflowY: 'auto' }}>
                                      {selectedCategorySubcategories.map((subcategory) => {
                                        ...
                                        return (
                                          <div 
                                            key={subcategory.id} 
                                            className={`list-group-item list-group-item-action border-0 ${isSelected ? 'bg-light border-start border-success border-3' : ''}`}
                                          >
                                            <div className="d-flex align-items-center">
                                              ...
                                              <div className="flex-grow-1">
                                                <h6 className="mb-1 text-dark">{subcategory.name}</h6>
                                    ...
                                    <div className="text-center py-5">
                                      ...
                                      <p className="mt-2 text-muted mb-0">No subcategories found</p>
                                  ...
                                  <div className="text-center py-5">
                                    ...
                                    <p className="mt-2 text-muted mb-0">Select a main category</p>
                                    <small className="text-muted">
                                      Click on a main category to see its subcategories here.
                                    </small>
                                  </div>
                                )}
                              </div>
