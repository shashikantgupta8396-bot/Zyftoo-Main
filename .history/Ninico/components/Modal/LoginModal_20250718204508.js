...
import { encryptData, decryptData, encryptAndStore, decryptAndRetrieve, setAuthToken } from '@/util/cryptoHelper';
                  ...
                  <>
                    ...
                    <button
                      ...
                      try {
                        ...
                        // Store token encrypted in localStorage
                        encryptAndStore('token', responseData.token);
