                ...
                {step === 'login' ? (
                  <>
                    ...
                    <button className="login-next"
                      onClick={() => {
                        console.log('Next button clicked, phone:', phone, 'length:', phone.length);
                        if (phone.length === 10) {
                          console.log('Setting step to login-password');
                  ...
                  <>
                    ...
                    <button
                      ...
                      try {
                        console.log('Login attempt with phone:', phone, 'password:', password ? '***' : 'empty');
                        console.log('Login payload being sent:', { phone, password: password ? '***' : 'empty' });
                  ...
                  <>
                    ...
                    <div className="form-vertical">
                      ...
                      }, false); // unencrypted signup                        if (!response.success) {
