...
export default function HeaderMobSticky({ scroll, isMobileMenu, handleMobileMenu, isCartSidebar, handleCartSidebar }) {
    ...
    return (
        <>
            <div id="header-mob-sticky" className={`tp-md-lg-header d-block d-md-none ${scroll ? "header-sticky" : ""}`} style={{ backgroundColor: '#000000' }}>
            ...
            <style jsx>{`
                ...
                /* Ensure other headers are completely hidden on mobile */
