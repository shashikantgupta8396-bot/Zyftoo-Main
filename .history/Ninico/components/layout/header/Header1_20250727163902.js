...
export default function Header1({ scroll, isMobileMenu, handleMobileMenu, isCartSidebar, handleCartSidebar }) {
    ...
    return (
        <>
            <header style={{ backgroundColor: '#000000', position: 'sticky', top: 0, zIndex: 999 }}>
                                ...
                                <div className="header-meta-info d-flex align-items-center justify-content-between">
                                    ...
                                    <div className="header-meta header-brand d-flex align-items-center">
                                        ...
                                        <div className="header-meta__social d-flex align-items-center ml-25">
                                            {/* Corporate User Button with Authentication Logic */}
                                            {user && user.userType === 'Corporate' ? (
                                                <Link href="/CorporateHome" className="corporate-user-btn me-3">
                                                    <button className="btn btn-primary btn-sm">
                                                        <i className="fal fa-building me-1" />
                                                        Corporate Dashboard
                                                    </button>
                                                </Link>
                                            ) : (
                                                <Link href="/corporate/sign-in" className="corporate-user-btn me-3">
