                                ...
                                <div className="header-meta-info d-flex align-items-center justify-content-between">
                                    ...
                                    <div className="header-meta header-brand d-flex align-items-center">
                                        ...
                                        <div className="header-meta__social d-flex align-items-center ml-25">
                                            ...
                                            <div 
                                                className="header-user-icon-wrapper position-relative"
                                            ...
                                            >
                                                ...
                                                {/* Profilebar dropdown positioned absolutely below user icon */}
                                                {showProfilebar && (
                                                    <div style={{ position: 'absolute', top: '100%', left: '50%', transform: 'translateX(-50%)', zIndex: 9999 }}>
                                                        <Profilebar
                                                            show={showProfilebar}
