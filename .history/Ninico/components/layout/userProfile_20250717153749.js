...
export default function UserProfile({ show, onClose }) {
                  ...
                  <div className="col-12">
                    ...
                    <div className="row g-3">
                      ...
                      <div className="col-md-4 col-sm-6">
                        <div className="text-center p-3 border-0">
                          <div className="mb-3">
                            <i className="fas fa-credit-card text-muted" style={{ fontSize: '24px' }}></i>
                          </div>
                          <h6 className="fw-bold mb-1" style={{ fontSize: '14px', color: '#282c3f' }}>Myntra Credit</h6>
                          <small className="text-muted" style={{ fontSize: '12px' }}>Manage all your refunds & gift cards</small>
                        </div>
                      </div>
                      ...
                      <div className="col-md-4 col-sm-6">
                        <div className="text-center p-3 border-0">
                          <div className="mb-3">
                            <i className="fas fa-coins text-muted" style={{ fontSize: '24px' }}></i>
                          </div>
                          <h6 className="fw-bold mb-1" style={{ fontSize: '14px', color: '#282c3f' }}>MynCash</h6>
                          <small className="text-muted" style={{ fontSize: '12px' }}>Earn MynCash as you shop & use them</small>
                        </div>
                      </div>
